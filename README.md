...
- `--no-browser`: Do not open a browser; manually enter the authorization code generated by the OIDC flow in the CLI.
...
- `noBrowser`: Optional boolean to disable opening a browser for OIDC authentication by default.
